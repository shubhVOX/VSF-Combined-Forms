        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    //>> Yogi.P 02102026 Multi Brand changes
                    // column(CompanyInfoPic; CompanyInformation.Picture)
                    // {
                    // }
                    column(CompanyInfoPic; RespCenter.Logo) { }
                    //<< Yogi.P 02102026
                    ...
                    dataitem(SalesLine; "Integer")
                    {
                        ...
                        {
                            //>> Yogi.P 14MAY2026 CAS-07191-X2J3
                            DecimalPlaces = 0 : 5;
                            // DecimalPlaces = 0 : 2;
                            //<< Yogi.P 14MAY2026
                        }
            ...
            begin
                ...
                if PrintCompany then begin
                    ...
                    // end;
                    RespCenter.Reset();
                    RespCenter.SetRange("Global Dimension 1 Code", "Sales Header"."Shortcut Dimension 1 Code");
                    RespCenter.SetAutoCalcFields(Logo);
                    if RespCenter.FindFirst() then begin
                        CompanyAddress[1] := RespCenter.Name;
                        CompanyAddress[2] := RespCenter.Address;
                        CompanyAddress[3] := RespCenter."Address 2";
                        if CountryRegionRec.GET(RespCenter."Country/Region Code") then;
                        CompanyAddress[4] := RespCenter.City + ',' + ' ' + RespCenter.County + ',' + ' ' + CountryRegionRec.Name + '  ' + RespCenter."Post Code";
                        CompanyAddress[5] := RespCenter."Phone No.";
                        CompanyAddress[6] := RespCenter."E-Mail";
                        CompanyAddress[7] := '';
                    ...
                    case TaxArea."Country/Region" of
                        ...
                        TaxArea."Country/Region"::CA:
                            begin
                                ...
                                TaxRegNo := RespCenter."VAT Registration No.";
                                TaxRegLabel := RespCenter.FieldCaption("VAT Registration No.");
                                //<< Yogi.P 02102026
                            end;
                    end;
